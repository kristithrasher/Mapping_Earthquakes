...
//TILE LAYER FOR BACKGROUND WITH DARK OPTION
...
// 1. Add a 2nd layer group for the tectonic plate data. (Deliverable 1 and Major Earthquake for deliverable 2)
let allEarthquakes = new L.LayerGroup();
let majorEarthquakeData = new L.layerGroup();
let tectonicPlateData = new L.layerGroup();
let largestEarthquakeUs = new L.layerGroup();
...
d3.json("https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_week.geojson").then(function (data) {
  ...
  L.geoJson(data, {
    ...
    //adding allearthquakes to all 3 maps
  ...
  // added variable to hold our data   
  ...
  //added this tetocinc plate data to all three maps
